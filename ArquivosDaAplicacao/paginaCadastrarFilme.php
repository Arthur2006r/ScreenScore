    ...
    <div class="container">
        ...
        <form id="formulario" action="filmeSalvar.php" method="post" enctype="multipart/form-data">
            <div class="row form-group">
                ...
                <div class="col-4">
                    <br>
                    <label for="imagemCapa" class="textoCapaBannerFilme">Capa filme</label>
                    <br>
                    <div id="previewCapa">
                        <img src="imagens/imagemPadraoCapa.png" class="capaFilme">
                        <br>
                        <br>
                        <input class="form-control" value="<?php echo $capaReserva ?>" id="imagemCapa" name="imagemCapa" type="file" onchange="previewImagemCapa()" style="width: 245px">
                    </div>
                    <div class="error-message-imagemCapa"></div>
                </div>
                <div class="col-8">
                    <br>
                    ...
                    <div id="previewBanner">
                        <img src="imagens/imagemPadraoBanner.png " class="bannerFilme">
                        <br>
                        <br>
                        <input class="form-control" value="<?php echo $banner ?>" id="imagemBanner" name="imagemBanner" type="file" onchange="previewImagemBanner()"  style="width: 730px">
                    </div>
                    <div class="error-message-imagemBanner"></div>
                </div>
            </div>
            <br>
            <br>
            ...
            <div id="formularios">
                ...
                <div id="textArea">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control input inputTextArea" id="sinopse" name="sinopse" style="height: 38vh;"><?= $sinopse ?></textarea>
                    </div>
