...
$filmesMaisCurtidos = listarFilmesMaisCurtidos();
    ...
    <div class="container">
        <div class="textoSimbolo">
            <p class="textoCatalogo">
                Confira os filmes mais curtidos
            </p>
        </div>
                ...
                ?>
                    <div class="col-md-3">
                        <div class="capaRanking">
                            <div class="capaFilme">
                                <a href="paginaSessaoFilme.php?codFilme=<?= $filme['codFilme']; ?>&codAvaliador=<?= $codAvaliador; ?>">
