        ...
        ?>
            <div class="mt-3">
                <div class="textoListaDeFilmes">
                    ...
                    <a href="sessaoCategoriaAdmin.php?categoria=Ação" class="linkVerMais">
                        Ver mais
                    </a>
                </div>
                <hr class="linha">
        ...
        ?>
            <div class="listaDeFilmes">
                <div class="textoListaDeFilmes">
                    ...
                    <a href="sessaoCategoriaAdmin.php?categoria=Aventura" class="linkVerMais">
                        Ver mais
                    </a>
                </div>
                <hr class="linha">
        ...
        ?>
            <div class="listaDeFilmes">
                <div class="textoListaDeFilmes">
                    ...
                    <a href="sessaoCategoriaAdmin.php?categoria=Romance" class="linkVerMais">
                        Ver mais
                    </a>
                </div>
                <hr class="linha">
        ...
        ?>
            <div class="listaDeFilmes">
                <div class="textoListaDeFilmes">
                    ...
                    <a href="sessaoCategoriaAdmin.php?categoria=Ficção científica" class="linkVerMais">
                        Ver mais
                    </a>
                </div>
                <hr class="linha">
        ...
        ?>
            <div class="listaDeFilmes">
                <div class="textoListaDeFilmes">
                    ...
                    <a href="sessaoCategoriaAdmin.php?categoria=Terror" class="linkVerMais">
                        Ver mais
                    </a>
                </div>
                <hr class="linha">
        ...
        ?>
            <div class="listaDeFilmes">
                <div class="textoListaDeFilmes">
                    ...
                    <a href="paginaFilmesAdicionadosRecentementeAdmin.php" class="linkVerMais">
                        Ver mais
                    </a>
                </div>
                <hr class="linha">
        ...
        ?>
            <div class="listaDeFilmes">
                <div class="textoListaDeFilmes">
                    ...
                    <a href="paginaTodosOsFilmesAdmin.php" class="linkVerMais">
                        Ver mais
                    </a>
                </div>
                <hr class="linha">
