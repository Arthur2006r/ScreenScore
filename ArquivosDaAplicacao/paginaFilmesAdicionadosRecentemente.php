...
if (isset($_GET['codAvaliador'])) {
    $codAvaliador = $_GET['codAvaliador'];
...
$filmesAdicionadosRecentemente = listarFilmesRecentes();
$tem = $filmesAdicionadosRecentemente[0] != null ? true : false;
?>
...
<head>
    <meta charset="utf-8" />
    <title> ScreenScore - Página adicionados recentemente </title>
    ...
    <div class="container">
        <div class="textoSimbolo mt-5">
            <p class="textoCatalogo">
                Confira os filmes em ordem de cadastro
            </p>
        </div>
        ...
        <?php if ($tem) { ?>
            <div class="listaDeFilmes">
                <?php
                $contador = 0;
                foreach ($filmesAdicionadosRecentemente as $filme) {
                    if ($contador % 4 === 0) {
                        if ($contador !== 0) {
                            echo '<br> <br> <br> <br>';
                        }
